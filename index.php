    ...
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
       <h1 ><b>200 million people</b></h1>
         <h1 > <b>go hungry everyday.</b></h1><br></br><br></br><br></br>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="images/i40.jpg" alt="Chicago" width="1100" height="500">
      <div class="carousel-caption">
        <h1>While 1.8 million kg food is wasted daily.</h1><br></br><br></br><br></br>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="images/i50.jfif" alt="New York" width="1100" height="500">
      <div class="carousel-caption">
        <h1>feed the hungry.</h1><br></br><br></br><br></br>         
    </div>
  </div>
...
<br><br> <div class="container-fluid bg-warning" style="padding-top:70px;padding-bottom:70px">
